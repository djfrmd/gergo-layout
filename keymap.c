...
[BASE] = LAYOUT_gergo(
    ...
    KC_CAPS, KC_A, KC_S, KC_D, KC_F,    KC_G,   KC_TRNS,                        KC_TRNS, KC_H,   KC_J,  KC_K,    KC_L,   KC_SCLN, KC_QUOT,
    KC_RSFT, KC_Z, KC_X, KC_C, KC_V,    KC_B,   KC_TRNS,  KC_TRNS,     KC_TRNS, KC_TRNS, KC_N,   KC_M,  KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
                               KC_BSPC, KC_SPC, MO(NUMB), KC_TRNS,     KC_TRNS, MO(NUMB), KC_ENT, KC_DEL
    ),
